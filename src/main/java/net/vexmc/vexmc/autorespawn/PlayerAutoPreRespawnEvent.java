package net.vexmc.vexmc.autorespawn;
...
public class PlayerAutoPreRespawnEvent extends Event implements Cancellable {
    ...
    public PlayerAutoPreRespawnEvent(Player p, Location deathLoc) {
        this.p = p;
